...
\captionof{figure}{Diagram ERD przedstawiający relacje w bazie danych}
\label{fig:erd}
\end{figure}
...
\begin{itemize}
  ...
  \begin{minipage}[t]{\linewidth}
    ...
    \vspace{0.3em}
    \begin{center}
      \includegraphics[width=0.75\linewidth]{dodajdruzyne.png}
  ...
  \begin{minipage}[t]{\linewidth}
    ...
    \vspace{0.3em}
    \begin{center}
      \includegraphics[width=0.75\linewidth]{dodaj pilkaza.png}
